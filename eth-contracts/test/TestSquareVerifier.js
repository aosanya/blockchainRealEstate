...
contract('Verifier', accounts => {
    ...
    describe('Verify Transaction', function () {
        ...
        it('Test verification with correct proof', async function () {
            let verified = await this.contract.verifyTx(
                ...
                [["0x2ea094b6ebc10f5b8d147fc56fbbc55e79b1c318777c08476f82b196d0cb6cb0", "0x28fb32244281051384b939ef853b011b2ee6b6327654b195c1470d14ac35f8ca"],
                ["0x1ba40b23d5f85ff6f6ee1aecfa5369317ed772e8c1957eaf4fb4160f34814966", "0x30862d90292e68fef82df9450f68a5415a8c0e698d3b9e0bace5a839cabcf03"]],
            ...
            assert.isTrue(verified.logs[0] != undefined, "Should have emitted an event")
            console.log(verified.logs[0].event)
            //assert.isTrue(verified.logs, "Proof is false")
            assert.isTrue(verified.logs[0].event == "Verified", "Not Verified")
        })
