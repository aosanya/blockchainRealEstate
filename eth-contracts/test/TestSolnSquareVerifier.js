...
contract('SolnSquareVerifier', accounts => {
    ...
    describe('Verify Transaction', function () {
        ...
        it('Test if an ERC721 token can be minted for contract - SolnSquareVerifier', async function () {
            ...
            assert.equal(totalSupply, 1, 'Error: Total Supply is wrong')

        })


        it('cannot mint token', async function () {
            try{
                ...
                assert.isTrue(e.toString().includes("revert ERROR_UNABLE_TO_VERFY_TOKEN"), "Unexpected throw recieved")
            }

            let totalSupply = await this.contract.totalSupply();
            assert.equal(totalSupply, 0, 'Error: Total Supply is wrong')
        ...
        it('Test if a new solution can be added for contract - SolnSquareVerifier', async function () {
            ...
            try{
                ...
                assert.isTrue(e.toString().includes("revert TOKEN_ALREADY_EXISTS"), "Unexpected throw recieved")
                return
            }
